...
//main function
int main() { 
printf("Mathematics for science (SPM 2104) \n");
printf("Fundamentals of ICT (UCU 2105) \n");
printf("Computer system and organisation (SPI 2102) \n");
printf("Communication skills (UCU 2101) \n");
